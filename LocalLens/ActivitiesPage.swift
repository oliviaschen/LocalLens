...
struct ActivitiesPage: View {
  @State private var activities:[Activity] = [
    ...
    Activity(name: "Golden Gate Park", imageName: "", desc: "The perfect shoujo spot full of picnics, walks, and endless fields of nature.")
  ]
  var body: some View {
    ZStack {
      VStack {
            ...
            ForEach($activities) { $activity in
              ...
              ZStack {
                ...
                HStack {
                  ...
                  Button(action: {
                    activity.isLiked.toggle() // :new: Heart toggle
